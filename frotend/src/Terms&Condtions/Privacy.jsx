    ...
    <div className="privacy-policy-container">
     <MetaData title={"Privacy Policy"} />
      <div className="container___">
        <h1>Privacy Policy of Luxe Fashions</h1>
        <p style={{ fontSize: "16px", fontWeight: "600" }}>
          {" "}
          Effective Date: 29-12-2023
        </p>
        <p>
          At Luxe Fashions, we value the privacy of our customers and are
        ...
        <p>
          By using the Luxe Fashions website and services, you agree to the
