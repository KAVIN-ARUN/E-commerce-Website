    ...
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        ...
        <p>
          ...
          experience purchasing from our webstore, LuxeFashions.com.
        </p>
        <p>
        ...
        <p>
          You (“Customer”) may place orders for Products with LuxeFashions
          ...
          agreed to or set forth in writing by LuxeFashions, any term or
        ...
        <h2>Orders</h2>
        <p>
          All orders are subject to LuxeFashions's acceptance. This means
          LuxeFashions may, for any reason, refuse to accept or may cancel or
          ...
          cancel an order after you have already been charged, LuxeFashions
        ...
        <p>
          ...
          and it is accepted by LuxeFashions. Prices for products displayed on
          ...
          website may differ from those in stores that stock LuxeFashions
          products, as these stores are independent of LuxeFashions.
          LuxeFashions reserves the right to amend pricing for any pricing
          ...
          submitted an online order, LuxeFashions will notify you of the error
        ...
        <p>
          ...
          LuxeFashions reserves the right to change or discontinue such offers
          at any time.
        </p>
        <h2>Taxes</h2>
        <p>
          The prices quoted for the products sold hereunder include applicable
          taxes. Customer shall pay, and reimburse LuxeFashions if it pays, any
          taxes, except for those based on LuxeFashions's income.
        </p>
        <h2>Payment</h2>
        <p>
        ...
        <p>
          ...
          process. Any timeframe provided by LuxeFashions for when the
          ...
          are beyond our control. LuxeFashions cannot be held liable for late
        ...
        <h2>Returns</h2>
        <p>
          Once an order has been placed and accepted by LuxeFashions, customer
          may not cancel such accepted order without LuxeFashions’s prior
          ...
          expenses. The product(s) must be returned to LuxeFashions within
        ...
        <p>
          ...
          indemnify and hold LuxeFashions harmless from and against any and all
        ...
        <p style={{ fontWeight: "500" }}>LuxeFashions</p>
        <p style={{ fontWeight: "500" }}>1701 N Orange Grove Ave, Hollywood, California, United States, 90046</p>
        <p style={{ fontWeight: "500" }}>
          Email:{" "}
          <span style={{ fontWeight: "400" }}>info@luxefashions.com</span>
        </p>
      </div>
    </div>
  );
