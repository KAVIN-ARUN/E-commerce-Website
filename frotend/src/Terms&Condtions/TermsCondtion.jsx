  ...
  return (
    <div className="terms-container">
      ...
      <div className="terms-content">
        <p>
          Thank you for shopping with LuxeFashions! We appreciate your business
        ...
        <p>
          ...
          agreed to in writing by LuxeFashions.
        </p>
        <h2>Orders</h2>
        <p>
          All orders are subject to LuxeFashions's acceptance. We may refuse to
        ...
        <p>
          ...
          LuxeFashions. Prices displayed on the website exclude shipping
          ...
          from those in physical stores that stock LuxeFashions products. We
        ...
        <p>
          ...
          taxes, except for those based on LuxeFashions's income. If
          LuxeFashions is required to collect and pay taxes on Customer's
        ...
        <p>
          ...
          order without LuxeFashions's written consent. You may return products
        ...
        <p>
          You agree to indemnify and hold LuxeFashions harmless from any
          claims, costs, proceedings, losses, or demands arising from your
          breach of these Terms or anyone using your account.
        </p>
        <h2>Entire Agreement</h2>
        <p>
          These Terms constitute the entire agreement between LuxeFashions and
