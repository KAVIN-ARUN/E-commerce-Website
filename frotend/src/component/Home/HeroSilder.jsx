...
const slides = [
  {
    image: require("../../Image/Luxe-fashions/banner1.jpg"),
    quote:
      "Welcome to a world where every click brings you closer to the perfect ensemble",
    saleText:
      "Unleash the power of fashion at your fingertips",
    productText: "Shop Now",
  },
  {
    image: require("../../Image/Luxe-fashions/banner2.jpg"),
    quote:
      "Elevate your style, embrace the extraordinary",
    saleText:
      "Discover trends that speak to your soul",
    productText: "Buy Now",
  },
  {
    image: require("../../Image/Luxe-fashions/banner3.jpg"),
    quote:
  ...
  { 
    image: require("../../Image/Luxe-fashions/banner4.jpg"),
    quote:
      "Elevate Your Performance and Unleash Your True Potential with Our Unique collection",
