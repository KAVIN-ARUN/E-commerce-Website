          ...
          <form className={classes.form}>
            ...
            >
              <Grid item>
                <FormControlLabel
                  control={<Checkbox />}
                  label="I Accept The Luxe Fashions Terms & Conditions"
              ...
              <Grid item>
                <FormControlLabel
                  control={<Checkbox />}
                  label="I Accept The Luxe Fashions Terms Of Use"
                  className={classes.checkbox}
            ...
            >
              I acknowledge Luxe Fashions will use my information in accordance
              with its
